...
| Native durable Thingd       | Available / early     | Optional `thingd-native` feature, compatible with Thingd `>=0.83.2, <0.84.0`. Recovery, backups, resource sizing, and workload testing remain deployment work.                        |
