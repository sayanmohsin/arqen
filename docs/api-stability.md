...
scoped backend, schema report, and Thingd 0.78.0 sync client types are supported
...
Cloud publishes versioned public contracts. Thingd 0.78.0 synchronization and
