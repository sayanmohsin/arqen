...
scoped backend, schema report, and Thingd 0.77.3 sync client types are supported
...
Cloud publishes versioned public contracts. Thingd 0.77.3 synchronization and
