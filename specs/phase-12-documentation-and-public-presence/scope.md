...
- Public identity, Node.js compatibility positioning, and agent-readable documentation conventions.

## Out of scope

- New framework features, cloud credentials, private APIs, or provider integrations.
- Watchloom, thingd, or thingd-cloud source changes.
- Claiming planned CLI, native durable, cloud, or Node.js work is complete.
